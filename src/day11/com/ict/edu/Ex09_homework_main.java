...
public class Ex09_homework_main {
...
//	단, 처리는 2차원 배열을 이용해라
	public static void main(String[] args) {
		...
		int su = scan.nextInt();
		double[][] arr = new double[su][8];  // 학생 정보를 저장할 배열
		//Ex09_homework_method test = new Ex09_homework_method();
		//나는 여기다 썼는데 그럼 값이 안나옴.
		...
		for (int i = 0; i < arr.length; i++) {
			...
			arr[i] = student;    //학생 정보를 저장할 배열
			//사용자가 입력한 수만큼 만들어진 student를 arr배열의 각 방에 들어가도록!
			//중요!
