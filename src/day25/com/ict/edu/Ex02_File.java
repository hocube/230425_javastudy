...
public static void main(String[] args) {
	...
	try { 
		...
		File file2 = new File("D:/PJH/EXAM/AAA");
		...
		//디렉토리 삭제
		File file4 = new File("D:/PJH/EXAM/AAA");
		boolean res4 = file4.delete();
		if(res4) {
			System.out.println("디렉토리 AAA 삭제 성공");
			File file5 = new File("D:/PJH/EXAM");
			...
			System.out.println("디렉토리 AAA 실패");
		}
		System.out.println("===================");
	} catch (IOException e) {
		System.out.println("위치가 틀렸습니다."); //위치가 틀리면 출력된다.
	}
}
}
